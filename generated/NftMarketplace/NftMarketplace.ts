...
export class ItemCancel extends ethereum.Event {
  get params(): ItemCancel__Params {
    return new ItemCancel__Params(this);
  }
}

export class ItemCancel__Params {
  _event: ItemCancel;

  constructor(event: ItemCancel) {
    this._event = event;
  }
